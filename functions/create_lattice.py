...
load_path = '/bilayer_homo_strain/xyz_files/'
save_path = '/bilayer_homo_strain/lattice_files/'
...
d_min_intra, d_max_intra = 0.95 * a_cc, 1.75 * a_cc
# min and max intralayer radius for neighbour search
d_min_inter, d_max_inter = 0.95 * c0, 1.40 * c0
